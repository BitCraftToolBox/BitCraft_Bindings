...
export type ParametersDesc = {
  ...
  maxSignedInPlayers: number,
  maxQueueLength: number,
  gracePeriodSeconds: number,
  itemRecoveryRange: number,
  regionTargetPopulation: number,
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("maxSignedInPlayers", AlgebraicType.createI32Type()),
      new ProductTypeElement("maxQueueLength", AlgebraicType.createI32Type()),
      new ProductTypeElement("gracePeriodSeconds", AlgebraicType.createI32Type()),
      new ProductTypeElement("itemRecoveryRange", AlgebraicType.createI32Type()),
      new ProductTypeElement("regionTargetPopulation", AlgebraicType.createI32Type()),
