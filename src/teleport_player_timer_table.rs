...
/// Lifetime-aware accessor marker for the table `teleport_player_timer`.
pub struct TeleportPlayerTimerTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for TeleportPlayerTimerTableAccessor {
    type Row = TeleportPlayerTimer;
    type Handle<'db> = TeleportPlayerTimerTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.teleport_player_timer()
    }
}
...
impl<'ctx> __sdk::TableLike for TeleportPlayerTimerTableHandle<'ctx> {
    type Row = TeleportPlayerTimer;
...
impl<'ctx> __sdk::WithInsert for TeleportPlayerTimerTableHandle<'ctx> {
    type InsertCallbackId = TeleportPlayerTimerInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for TeleportPlayerTimerTableHandle<'ctx> {
    type DeleteCallbackId = TeleportPlayerTimerDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for TeleportPlayerTimerTableHandle<'ctx> {
    type UpdateCallbackId = TeleportPlayerTimerUpdateCallbackId;
