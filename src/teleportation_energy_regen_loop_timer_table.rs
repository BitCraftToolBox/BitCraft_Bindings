...
/// Lifetime-aware accessor marker for the table `teleportation_energy_regen_loop_timer`.
pub struct TeleportationEnergyRegenLoopTimerTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for TeleportationEnergyRegenLoopTimerTableAccessor {
    type Row = TeleportationEnergyRegenLoopTimer;
    type Handle<'db> = TeleportationEnergyRegenLoopTimerTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.teleportation_energy_regen_loop_timer()
    }
}
...
impl<'ctx> __sdk::TableLike for TeleportationEnergyRegenLoopTimerTableHandle<'ctx> {
    type Row = TeleportationEnergyRegenLoopTimer;
...
impl<'ctx> __sdk::WithInsert for TeleportationEnergyRegenLoopTimerTableHandle<'ctx> {
    type InsertCallbackId = TeleportationEnergyRegenLoopTimerInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for TeleportationEnergyRegenLoopTimerTableHandle<'ctx> {
    type DeleteCallbackId = TeleportationEnergyRegenLoopTimerDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for TeleportationEnergyRegenLoopTimerTableHandle<'ctx> {
    type UpdateCallbackId = TeleportationEnergyRegenLoopTimerUpdateCallbackId;
