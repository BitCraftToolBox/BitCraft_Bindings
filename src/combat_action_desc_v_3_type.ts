 ...
 */
export namespace CombatActionDescV3 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: CombatActionDescV3): void {
    CombatActionDescV3.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): CombatActionDescV3 {
    return CombatActionDescV3.getTypeScriptAlgebraicType().deserialize(reader);
  }
