...
pub trait import_equipment_state {
    ...
    fn on_import_equipment_state(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<EquipmentState>, ) + Send + 'static) -> ImportEquipmentStateCallbackId;
...
impl import_equipment_state for super::RemoteReducers {
    fn import_equipment_state(&self, records: Vec::<EquipmentState>,
        ...
        self.imp.call_reducer("import_equipment_state", ImportEquipmentStateArgs { records,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportEquipmentState {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_import_equipment_state(&self, callback: ImportEquipmentStateCallbackId) {
        self.imp.remove_on_reducer("import_equipment_state", callback.0)
    }
}
...
impl set_flags_for_import_equipment_state for super::SetReducerFlags {
    fn import_equipment_state(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("import_equipment_state", flags);
    }
}
