...
/// Lifetime-aware accessor marker for the table `staged_deployable_desc`.
pub struct StagedDeployableDescTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for StagedDeployableDescTableAccessor {
    type Row = DeployableDesc;
    type Handle<'db> = StagedDeployableDescTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.staged_deployable_desc()
    }
}
...
impl<'ctx> __sdk::TableLike for StagedDeployableDescTableHandle<'ctx> {
    type Row = DeployableDesc;
...
impl<'ctx> __sdk::WithInsert for StagedDeployableDescTableHandle<'ctx> {
    type InsertCallbackId = StagedDeployableDescInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for StagedDeployableDescTableHandle<'ctx> {
    type DeleteCallbackId = StagedDeployableDescDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for StagedDeployableDescTableHandle<'ctx> {
    type UpdateCallbackId = StagedDeployableDescUpdateCallbackId;
