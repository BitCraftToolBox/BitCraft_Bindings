...
pub trait paving_place_tile {
    ...
    fn on_paving_place_tile(&self, callback: impl FnMut(&super::ReducerEventContext, &PlayerPavingPlaceTileRequest, ) + Send + 'static) -> PavingPlaceTileCallbackId;
...
impl paving_place_tile for super::RemoteReducers {
    fn paving_place_tile(&self, request: PlayerPavingPlaceTileRequest,
        ...
        self.imp.call_reducer("paving_place_tile", PavingPlaceTileArgs { request,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::PavingPlaceTile {
                            request, 
                        },
                        ..
                    },
