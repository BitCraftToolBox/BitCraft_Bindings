...
new_name: String,
    ...
    fn on_admin_set_sign_text_coord(&self, callback: impl FnMut(&super::ReducerEventContext, &OffsetCoordinatesSmallMessage, &String, ) + Send + 'static) -> AdminSetSignTextCoordCallbackId;
...
new_name: String,
        ...
        self.imp.call_reducer("admin_set_sign_text_coord", AdminSetSignTextCoordArgs { coord, new_name,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminSetSignTextCoord {
                            coord, new_name, 
                        },
                        ..
                    },
    ...
    fn remove_on_admin_set_sign_text_coord(&self, callback: AdminSetSignTextCoordCallbackId) {
        self.imp.remove_on_reducer("admin_set_sign_text_coord", callback.0)
    }
}
...
impl set_flags_for_admin_set_sign_text_coord for super::SetReducerFlags {
    fn admin_set_sign_text_coord(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_set_sign_text_coord", flags);
    }
}
