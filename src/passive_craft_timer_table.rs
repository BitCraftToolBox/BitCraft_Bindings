...
/// Lifetime-aware accessor marker for the table `passive_craft_timer`.
pub struct PassiveCraftTimerTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for PassiveCraftTimerTableAccessor {
    type Row = PassiveCraftTimer;
    type Handle<'db> = PassiveCraftTimerTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.passive_craft_timer()
    }
}
...
impl<'ctx> __sdk::TableLike for PassiveCraftTimerTableHandle<'ctx> {
    type Row = PassiveCraftTimer;
...
impl<'ctx> __sdk::WithInsert for PassiveCraftTimerTableHandle<'ctx> {
    type InsertCallbackId = PassiveCraftTimerInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for PassiveCraftTimerTableHandle<'ctx> {
    type DeleteCallbackId = PassiveCraftTimerDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for PassiveCraftTimerTableHandle<'ctx> {
    type UpdateCallbackId = PassiveCraftTimerUpdateCallbackId;
