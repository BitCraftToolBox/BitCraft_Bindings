...
export type ParametersDescV2 = {
  ...
  coOwnerTakeOwnershipSupplyTime: number,
  officerTakeOwnershipSupplyTime: number,
  memberTakeOwnershipSupplyTime: number,
};

/**
 * A namespace for generated helper functions.
 */
export namespace ParametersDescV2 {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("coOwnerTakeOwnershipSupplyTime", AlgebraicType.createI32Type()),
      new ProductTypeElement("officerTakeOwnershipSupplyTime", AlgebraicType.createI32Type()),
      new ProductTypeElement("memberTakeOwnershipSupplyTime", AlgebraicType.createI32Type()),
    ]);
  }

  export function serialize(writer: BinaryWriter, value: ParametersDescV2): void {
    ParametersDescV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): ParametersDescV2 {
    return ParametersDescV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
