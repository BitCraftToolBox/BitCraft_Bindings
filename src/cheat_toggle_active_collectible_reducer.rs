...
pub trait cheat_toggle_active_collectible {
    ...
    fn on_cheat_toggle_active_collectible(&self, callback: impl FnMut(&super::ReducerEventContext, &CheatToggleActiveCollectibleRequest, ) + Send + 'static) -> CheatToggleActiveCollectibleCallbackId;
    /// Cancel a callback previously registered by [`Self::on_cheat_toggle_active_collectible`],
    /// causing it not to run in the future.
    fn remove_on_cheat_toggle_active_collectible(&self, callback: CheatToggleActiveCollectibleCallbackId);
}

impl cheat_toggle_active_collectible for super::RemoteReducers {
    fn cheat_toggle_active_collectible(&self, request: CheatToggleActiveCollectibleRequest,
) -> __sdk::Result<()> {
        self.imp.call_reducer("cheat_toggle_active_collectible", CheatToggleActiveCollectibleArgs { request,  })
    }
    fn on_cheat_toggle_active_collectible(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &CheatToggleActiveCollectibleRequest, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatToggleActiveCollectible {
                            request, 
                        },
                        ..
                    },
    ...
    fn remove_on_cheat_toggle_active_collectible(&self, callback: CheatToggleActiveCollectibleCallbackId) {
        self.imp.remove_on_reducer("cheat_toggle_active_collectible", callback.0)
    }
}
...
impl set_flags_for_cheat_toggle_active_collectible for super::SetReducerFlags {
    fn cheat_toggle_active_collectible(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("cheat_toggle_active_collectible", flags);
    }
}
