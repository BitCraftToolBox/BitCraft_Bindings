...
/// Lifetime-aware accessor marker for the table `reset_chunk_index_timer`.
pub struct ResetChunkIndexTimerTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for ResetChunkIndexTimerTableAccessor {
    type Row = ResetChunkIndexTimer;
    type Handle<'db> = ResetChunkIndexTimerTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.reset_chunk_index_timer()
    }
}
...
impl<'ctx> __sdk::TableLike for ResetChunkIndexTimerTableHandle<'ctx> {
    type Row = ResetChunkIndexTimer;
...
impl<'ctx> __sdk::WithInsert for ResetChunkIndexTimerTableHandle<'ctx> {
    type InsertCallbackId = ResetChunkIndexTimerInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for ResetChunkIndexTimerTableHandle<'ctx> {
    type DeleteCallbackId = ResetChunkIndexTimerDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for ResetChunkIndexTimerTableHandle<'ctx> {
    type UpdateCallbackId = ResetChunkIndexTimerUpdateCallbackId;
