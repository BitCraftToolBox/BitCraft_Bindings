...
pub trait passive_craft_collect {
    ...
    fn on_passive_craft_collect(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> PassiveCraftCollectCallbackId;
...
impl passive_craft_collect for super::RemoteReducers {
    fn passive_craft_collect(&self, passive_craft_entity_id: u64,
        ...
        self.imp.call_reducer("passive_craft_collect", PassiveCraftCollectArgs { passive_craft_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::PassiveCraftCollect {
    ...
    fn remove_on_passive_craft_collect(&self, callback: PassiveCraftCollectCallbackId) {
        self.imp.remove_on_reducer("passive_craft_collect", callback.0)
    }
}
...
impl set_flags_for_passive_craft_collect for super::SetReducerFlags {
    fn passive_craft_collect(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("passive_craft_collect", flags);
    }
}
