...
pub trait trade_swap_pockets {
    ...
    fn on_trade_swap_pockets(&self, callback: impl FnMut(&super::ReducerEventContext, &PlayerTradeSwapPocketsRequest, ) + Send + 'static) -> TradeSwapPocketsCallbackId;
...
impl trade_swap_pockets for super::RemoteReducers {
    fn trade_swap_pockets(&self, request: PlayerTradeSwapPocketsRequest,
        ...
        self.imp.call_reducer("trade_swap_pockets", TradeSwapPocketsArgs { request,  })
    }
    fn on_trade_swap_pockets(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &PlayerTradeSwapPocketsRequest, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::TradeSwapPockets {
                            request, 
                        },
                        ..
                    },
