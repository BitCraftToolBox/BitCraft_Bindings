...
pub trait enemy_despawn_from_mob_monitor {
    ...
    fn on_enemy_despawn_from_mob_monitor(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> EnemyDespawnFromMobMonitorCallbackId;
    /// Cancel a callback previously registered by [`Self::on_enemy_despawn_from_mob_monitor`],
    /// causing it not to run in the future.
    fn remove_on_enemy_despawn_from_mob_monitor(&self, callback: EnemyDespawnFromMobMonitorCallbackId);
}

impl enemy_despawn_from_mob_monitor for super::RemoteReducers {
    fn enemy_despawn_from_mob_monitor(&self, enemy_entity_id: u64,
) -> __sdk::Result<()> {
        self.imp.call_reducer("enemy_despawn_from_mob_monitor", EnemyDespawnFromMobMonitorArgs { enemy_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::EnemyDespawnFromMobMonitor {
                            enemy_entity_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_enemy_despawn_from_mob_monitor(&self, callback: EnemyDespawnFromMobMonitorCallbackId) {
        self.imp.remove_on_reducer("enemy_despawn_from_mob_monitor", callback.0)
    }
}
...
impl set_flags_for_enemy_despawn_from_mob_monitor for super::SetReducerFlags {
    fn enemy_despawn_from_mob_monitor(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("enemy_despawn_from_mob_monitor", flags);
    }
}
