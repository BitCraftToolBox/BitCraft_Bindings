...
export namespace MessageContentsV4 {
  ...
  // assert!(foo.value === 42);
  // ```
  export const TableUpdate = (value: __InterModuleTableUpdates): MessageContentsV4 => ({ tag: "TableUpdate", value });
  ...
  export const OnDeployableRecovered = (value: __OnDeployableRecoveredMsg): MessageContentsV4 => ({ tag: "OnDeployableRecovered", value });
...
export type MessageContentsV4 = MessageContentsV4.TableUpdate | MessageContentsV4.TransferPlayerRequest | MessageContentsV4.TransferPlayerHousingRequest | MessageContentsV4.PlayerCreateRequest | MessageContentsV4.UserUpdateRegionRequest | MessageContentsV4.OnPlayerNameSetRequest | MessageContentsV4.ClaimCreateEmpireSettlementState | MessageContentsV4.OnClaimMembersChanged | MessageContentsV4.EmpireCreateBuilding | MessageContentsV4.OnEmpireBuildingDeleted | MessageContentsV4.GlobalDeleteEmpireBuilding | MessageContentsV4.DeleteEmpire | MessageContentsV4.EmpireClaimJoin | MessageContentsV4.EmpireResupplyNode | MessageContentsV4.EmpireCollectHexiteCapsule | MessageContentsV4.EmpireStartSiege | MessageContentsV4.EmpireSiegeAddSupplies | MessageContentsV4.OnPlayerJoinedEmpire | MessageContentsV4.OnPlayerLeftEmpire | MessageContentsV4.RegionDestroySiegeEngine | MessageContentsV4.OnRegionPlayerCreated | MessageContentsV4.EmpireQueueSupplies | MessageContentsV4.EmpireUpdateEmperorCrown | MessageContentsV4.EmpireRemoveCrown | MessageContentsV4.SignPlayerOut | MessageContentsV4.AdminBroadcastMessage | MessageContentsV4.PlayerSkipQueue | MessageContentsV4.GrantHubItem | MessageContentsV4.RecoverDeployable | MessageContentsV4.OnDeployableRecovered | MessageContentsV4.ReplaceIdentity;
