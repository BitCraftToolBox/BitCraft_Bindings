 ...
 */
export namespace DeployableDescV2 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: DeployableDescV2): void {
    DeployableDescV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): DeployableDescV2 {
    return DeployableDescV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
