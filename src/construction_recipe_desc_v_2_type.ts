...
export type ConstructionRecipeDescV2 = {
  id: number,
  name: string,
 ...
 */
export namespace ConstructionRecipeDescV2 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: ConstructionRecipeDescV2): void {
    ConstructionRecipeDescV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): ConstructionRecipeDescV2 {
    return ConstructionRecipeDescV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
