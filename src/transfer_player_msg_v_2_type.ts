 ...
 */
export namespace TransferPlayerMsgV2 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: TransferPlayerMsgV2): void {
    TransferPlayerMsgV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): TransferPlayerMsgV2 {
    return TransferPlayerMsgV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
