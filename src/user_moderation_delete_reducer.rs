...
pub trait user_moderation_delete {
    ...
    fn on_user_moderation_delete(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> UserModerationDeleteCallbackId;
...
impl user_moderation_delete for super::RemoteReducers {
    fn user_moderation_delete(&self, policy_entity_id: u64,
        ...
        self.imp.call_reducer("user_moderation_delete", UserModerationDeleteArgs { policy_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::UserModerationDelete {
                            policy_entity_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_user_moderation_delete(&self, callback: UserModerationDeleteCallbackId) {
        self.imp.remove_on_reducer("user_moderation_delete", callback.0)
    }
}
...
impl set_flags_for_user_moderation_delete for super::SetReducerFlags {
    fn user_moderation_delete(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("user_moderation_delete", flags);
    }
}
