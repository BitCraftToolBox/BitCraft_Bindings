...
pub trait respawn_interior_npcs {
    ...
    fn on_respawn_interior_npcs(&self, callback: impl FnMut(&super::ReducerEventContext, ) + Send + 'static) -> RespawnInteriorNpcsCallbackId;
...
impl respawn_interior_npcs for super::RemoteReducers {
    fn respawn_interior_npcs(&self, ) -> __sdk::Result<()> {
        self.imp.call_reducer("respawn_interior_npcs", RespawnInteriorNpcsArgs {  })
    }
    ...
    fn remove_on_respawn_interior_npcs(&self, callback: RespawnInteriorNpcsCallbackId) {
        self.imp.remove_on_reducer("respawn_interior_npcs", callback.0)
    }
}
...
impl set_flags_for_respawn_interior_npcs for super::SetReducerFlags {
    fn respawn_interior_npcs(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("respawn_interior_npcs", flags);
    }
}
