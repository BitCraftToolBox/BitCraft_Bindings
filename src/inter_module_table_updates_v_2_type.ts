...
import { RegionExplorationInfoOp as __RegionExplorationInfoOp } from "./region_exploration_info_op_type";

export type InterModuleTableUpdatesV2 = {
  ...
  regionExplorationInfo: __RegionExplorationInfoOp[] | undefined,
 ...
 */
export namespace InterModuleTableUpdatesV2 {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("regionExplorationInfo", AlgebraicType.createOptionType(AlgebraicType.createArrayType(__RegionExplorationInfoOp.getTypeScriptAlgebraicType()))),
  ...
  export function serialize(writer: BinaryWriter, value: InterModuleTableUpdatesV2): void {
    InterModuleTableUpdatesV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): InterModuleTableUpdatesV2 {
    return InterModuleTableUpdatesV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
