...
export namespace CharacterStatType {
  ...
  export type CartSpeed = { tag: "CartSpeed" };
  export type MountSpeed = { tag: "MountSpeed" };
  export type BoatSpeed = { tag: "BoatSpeed" };
  ...
  export const CartSpeed = { tag: "CartSpeed" };
  export const MountSpeed = { tag: "MountSpeed" };
  export const BoatSpeed = { tag: "BoatSpeed" };
  ...
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createSumType([
      ...
      new SumTypeVariant("CartSpeed", AlgebraicType.createProductType([])),
      new SumTypeVariant("MountSpeed", AlgebraicType.createProductType([])),
      new SumTypeVariant("BoatSpeed", AlgebraicType.createProductType([])),
    ]);
  }
