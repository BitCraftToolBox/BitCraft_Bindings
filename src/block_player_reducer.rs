...
pub trait block_player {
    ...
    fn on_block_player(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> BlockPlayerCallbackId;
...
impl block_player for super::RemoteReducers {
    fn block_player(&self, player_entity_id: u64,
        ...
        self.imp.call_reducer("block_player", BlockPlayerArgs { player_entity_id,  })
    }
    fn on_block_player(
        &self,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::BlockPlayer {
                            player_entity_id, 
                        },
                        ..
                    },
