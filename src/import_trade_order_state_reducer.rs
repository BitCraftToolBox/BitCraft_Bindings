...
pub trait import_trade_order_state {
    ...
    fn on_import_trade_order_state(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<TradeOrderState>, ) + Send + 'static) -> ImportTradeOrderStateCallbackId;
...
impl import_trade_order_state for super::RemoteReducers {
    fn import_trade_order_state(&self, records: Vec::<TradeOrderState>,
        ...
        self.imp.call_reducer("import_trade_order_state", ImportTradeOrderStateArgs { records,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportTradeOrderState {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_import_trade_order_state(&self, callback: ImportTradeOrderStateCallbackId) {
        self.imp.remove_on_reducer("import_trade_order_state", callback.0)
    }
}
...
impl set_flags_for_import_trade_order_state for super::SetReducerFlags {
    fn import_trade_order_state(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("import_trade_order_state", flags);
    }
}
