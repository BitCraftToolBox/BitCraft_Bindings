...
pub trait import_interior_network_desc {
    ...
    fn on_import_interior_network_desc(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<InteriorNetworkDesc>, ) + Send + 'static) -> ImportInteriorNetworkDescCallbackId;
...
impl import_interior_network_desc for super::RemoteReducers {
    fn import_interior_network_desc(&self, records: Vec::<InteriorNetworkDesc>,
        ...
        self.imp.call_reducer("import_interior_network_desc", ImportInteriorNetworkDescArgs { records,  })
    }
    fn on_import_interior_network_desc(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &Vec::<InteriorNetworkDesc>, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportInteriorNetworkDesc {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_import_interior_network_desc(&self, callback: ImportInteriorNetworkDescCallbackId) {
        self.imp.remove_on_reducer("import_interior_network_desc", callback.0)
    }
}
...
impl set_flags_for_import_interior_network_desc for super::SetReducerFlags {
    fn import_interior_network_desc(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("import_interior_network_desc", flags);
    }
}
