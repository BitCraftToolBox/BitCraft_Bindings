...
pub trait cheat_warp {
    ...
    fn on_cheat_warp(&self, callback: impl FnMut(&super::ReducerEventContext, &CheatWarpRequest, ) + Send + 'static) -> CheatWarpCallbackId;
...
impl cheat_warp for super::RemoteReducers {
    fn cheat_warp(&self, request: CheatWarpRequest,
        ...
        self.imp.call_reducer("cheat_warp", CheatWarpArgs { request,  })
    }
    fn on_cheat_warp(
        &self,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatWarp {
                            request, 
                        },
                        ..
                    },
