...
export class KnowledgeStatModifierDescTableHandle {
  tableCache: __TableCache<KnowledgeStatModifierDesc>;

  constructor(tableCache: __TableCache<KnowledgeStatModifierDesc>) {
  ...
  secondaryKnowledgeId = {
    ...
    find: (col_val: number): KnowledgeStatModifierDesc | undefined => {
      for (let row of this.tableCache.iter()) {
        if (__deepEqual(row.secondaryKnowledgeId, col_val)) {
          return row;
        }
      }
    },
