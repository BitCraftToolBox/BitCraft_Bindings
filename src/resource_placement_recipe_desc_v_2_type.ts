...
export type ResourcePlacementRecipeDescV2 = {
  id: number,
  name: string,
 ...
 */
export namespace ResourcePlacementRecipeDescV2 {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("requiredClaimTechIds", AlgebraicType.createArrayType(AlgebraicType.createI32Type())),
  ...
  export function serialize(writer: BinaryWriter, value: ResourcePlacementRecipeDescV2): void {
    ResourcePlacementRecipeDescV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): ResourcePlacementRecipeDescV2 {
    return ResourcePlacementRecipeDescV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
