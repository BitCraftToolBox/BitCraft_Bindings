...
pub trait import_knowledge_extract_state {
    ...
    fn on_import_knowledge_extract_state(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<KnowledgeExtractState>, ) + Send + 'static) -> ImportKnowledgeExtractStateCallbackId;
    /// Cancel a callback previously registered by [`Self::on_import_knowledge_extract_state`],
    /// causing it not to run in the future.
    fn remove_on_import_knowledge_extract_state(&self, callback: ImportKnowledgeExtractStateCallbackId);
}

impl import_knowledge_extract_state for super::RemoteReducers {
    fn import_knowledge_extract_state(&self, records: Vec::<KnowledgeExtractState>,
) -> __sdk::Result<()> {
        self.imp.call_reducer("import_knowledge_extract_state", ImportKnowledgeExtractStateArgs { records,  })
    }
    fn on_import_knowledge_extract_state(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &Vec::<KnowledgeExtractState>, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportKnowledgeExtractState {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_import_knowledge_extract_state(&self, callback: ImportKnowledgeExtractStateCallbackId) {
        self.imp.remove_on_reducer("import_knowledge_extract_state", callback.0)
    }
}
...
impl set_flags_for_import_knowledge_extract_state for super::SetReducerFlags {
    fn import_knowledge_extract_state(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("import_knowledge_extract_state", flags);
    }
}
