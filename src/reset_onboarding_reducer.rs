...
pub trait reset_onboarding {
    ...
    fn on_reset_onboarding(&self, callback: impl FnMut(&super::ReducerEventContext, ) + Send + 'static) -> ResetOnboardingCallbackId;
...
impl reset_onboarding for super::RemoteReducers {
    fn reset_onboarding(&self, ) -> __sdk::Result<()> {
        self.imp.call_reducer("reset_onboarding", ResetOnboardingArgs {  })
    }
