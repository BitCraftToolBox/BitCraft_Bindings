 ...
 *
 * Obtain a handle from the [`stagedPlaceablePlacementDesc`] property on [`RemoteTables`],
 * like `ctx.db.stagedPlaceablePlacementDesc`.
 *
 * Users are encouraged not to explicitly reference this type,
 * but to directly chain method calls,
 * like `ctx.db.stagedPlaceablePlacementDesc.on_insert(...)`.
 */
export class StagedPlaceablePlacementDescTableHandle {
   ...
   * Users are encouraged not to explicitly reference this type,
   * but to directly chain method calls,
   * like `ctx.db.stagedPlaceablePlacementDesc.id().find(...)`.
   *
