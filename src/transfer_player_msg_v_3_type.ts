...
import { DeployableCollectibleStateV2 as __DeployableCollectibleStateV2 } from "./deployable_collectible_state_v_2_type";
...
export type TransferPlayerMsgV3 = {
  ...
  deployableCollectibleStateV2: __DeployableCollectibleStateV2[],
  ...
  playerSettingsState: __PlayerSettingsStateV2 | undefined,
};
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("deployableCollectibleStateV2", AlgebraicType.createArrayType(__DeployableCollectibleStateV2.getTypeScriptAlgebraicType())),
      ...
      new ProductTypeElement("playerSettingsState", AlgebraicType.createOptionType(__PlayerSettingsStateV2.getTypeScriptAlgebraicType())),
    ]);
  }
