...
export type TransferPlayerMsgV3 = {
 ...
 */
export namespace TransferPlayerMsgV3 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: TransferPlayerMsgV3): void {
    TransferPlayerMsgV3.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): TransferPlayerMsgV3 {
    return TransferPlayerMsgV3.getTypeScriptAlgebraicType().deserialize(reader);
  }
