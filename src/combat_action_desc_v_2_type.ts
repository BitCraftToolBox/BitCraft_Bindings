 ...
 */
export namespace CombatActionDescV2 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: CombatActionDescV2): void {
    CombatActionDescV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): CombatActionDescV2 {
    return CombatActionDescV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
