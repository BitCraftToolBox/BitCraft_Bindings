 ...
 *
 * Obtain a handle from the [`stagedBuildingSpawnDesc`] property on [`RemoteTables`],
 * like `ctx.db.stagedBuildingSpawnDesc`.
 *
 * Users are encouraged not to explicitly reference this type,
 * but to directly chain method calls,
 * like `ctx.db.stagedBuildingSpawnDesc.on_insert(...)`.
 */
export class StagedBuildingSpawnDescTableHandle {
   ...
   * Users are encouraged not to explicitly reference this type,
   * but to directly chain method calls,
   * like `ctx.db.stagedBuildingSpawnDesc.id().find(...)`.
   *
