 ...
 */
export namespace EmpireCreateMsg {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: EmpireCreateMsg): void {
    EmpireCreateMsg.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): EmpireCreateMsg {
    return EmpireCreateMsg.getTypeScriptAlgebraicType().deserialize(reader);
  }
