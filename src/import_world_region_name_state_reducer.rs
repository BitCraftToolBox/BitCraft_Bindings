...
pub trait import_world_region_name_state {
    ...
    fn on_import_world_region_name_state(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<WorldRegionNameState>, ) + Send + 'static) -> ImportWorldRegionNameStateCallbackId;
    /// Cancel a callback previously registered by [`Self::on_import_world_region_name_state`],
    /// causing it not to run in the future.
    fn remove_on_import_world_region_name_state(&self, callback: ImportWorldRegionNameStateCallbackId);
}

impl import_world_region_name_state for super::RemoteReducers {
    fn import_world_region_name_state(&self, records: Vec::<WorldRegionNameState>,
) -> __sdk::Result<()> {
        self.imp.call_reducer("import_world_region_name_state", ImportWorldRegionNameStateArgs { records,  })
    }
    fn on_import_world_region_name_state(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &Vec::<WorldRegionNameState>, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportWorldRegionNameState {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_import_world_region_name_state(&self, callback: ImportWorldRegionNameStateCallbackId) {
        self.imp.remove_on_reducer("import_world_region_name_state", callback.0)
    }
}
...
impl set_flags_for_import_world_region_name_state for super::SetReducerFlags {
    fn import_world_region_name_state(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("import_world_region_name_state", flags);
    }
}
