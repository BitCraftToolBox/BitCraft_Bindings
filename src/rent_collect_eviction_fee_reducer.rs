...
pub trait rent_collect_eviction_fee {
    ...
    fn on_rent_collect_eviction_fee(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> RentCollectEvictionFeeCallbackId;
...
impl rent_collect_eviction_fee for super::RemoteReducers {
    fn rent_collect_eviction_fee(&self, rent_entity_id: u64,
        ...
        self.imp.call_reducer("rent_collect_eviction_fee", RentCollectEvictionFeeArgs { rent_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::RentCollectEvictionFee {
                            rent_entity_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_rent_collect_eviction_fee(&self, callback: RentCollectEvictionFeeCallbackId) {
        self.imp.remove_on_reducer("rent_collect_eviction_fee", callback.0)
    }
}
...
impl set_flags_for_rent_collect_eviction_fee for super::SetReducerFlags {
    fn rent_collect_eviction_fee(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("rent_collect_eviction_fee", flags);
    }
}
