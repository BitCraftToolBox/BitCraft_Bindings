 ...
 *
 * Obtain a handle from the [`stagedCombatActionDesc`] property on [`RemoteTables`],
 * like `ctx.db.stagedCombatActionDesc`.
 *
 * Users are encouraged not to explicitly reference this type,
 * but to directly chain method calls,
 * like `ctx.db.stagedCombatActionDesc.on_insert(...)`.
 */
export class StagedCombatActionDescTableHandle {
   ...
   * Users are encouraged not to explicitly reference this type,
   * but to directly chain method calls,
   * like `ctx.db.stagedCombatActionDesc.id().find(...)`.
   *
