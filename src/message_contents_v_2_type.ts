...
import { TransferPlayerMsgV2 as __TransferPlayerMsgV2 } from "./transfer_player_msg_v_2_type";
import { EmpireWithdrawItemMsg as __EmpireWithdrawItemMsg } from "./empire_withdraw_item_msg_type";

// A namespace for generated variants and helper functions.
export namespace MessageContentsV2 {
  // These are the generated variant types for each variant of the tagged union.
  // One type is generated per variant and will be used in the `value` field of
  // the tagged union.
  export type TableUpdate = { tag: "TableUpdate", value: __InterModuleTableUpdates };
  export type TransferPlayerRequest = { tag: "TransferPlayerRequest", value: __TransferPlayerMsgV2 };
  ...
  // assert!(foo.value === 42);
  // ```
  export const TableUpdate = (value: __InterModuleTableUpdates): MessageContentsV2 => ({ tag: "TableUpdate", value });
  export const TransferPlayerRequest = (value: __TransferPlayerMsgV2): MessageContentsV2 => ({ tag: "TransferPlayerRequest", value });
  export const TransferPlayerHousingRequest = (value: __TransferPlayerHousingMsg): MessageContentsV2 => ({ tag: "TransferPlayerHousingRequest", value });
  export const PlayerCreateRequest = (value: __PlayerCreateMsg): MessageContentsV2 => ({ tag: "PlayerCreateRequest", value });
  export const UserUpdateRegionRequest = (value: __UserUpdateRegionMsg): MessageContentsV2 => ({ tag: "UserUpdateRegionRequest", value });
  export const OnPlayerNameSetRequest = (value: __OnPlayerNameSetMsg): MessageContentsV2 => ({ tag: "OnPlayerNameSetRequest", value });
  export const ClaimCreateEmpireSettlementState = (value: __ClaimCreateEmpireSettlementMsg): MessageContentsV2 => ({ tag: "ClaimCreateEmpireSettlementState", value });
  export const OnClaimMembersChanged = (value: __OnClaimMembersChangedMsg): MessageContentsV2 => ({ tag: "OnClaimMembersChanged", value });
  export const EmpireCreateBuilding = (value: __EmpireCreateBuildingMsg): MessageContentsV2 => ({ tag: "EmpireCreateBuilding", value });
  export const OnEmpireBuildingDeleted = (value: __OnEmpireBuildingDeletedMsg): MessageContentsV2 => ({ tag: "OnEmpireBuildingDeleted", value });
  export const GlobalDeleteEmpireBuilding = (value: __GlobalDeleteEmpireBuildingMsg): MessageContentsV2 => ({ tag: "GlobalDeleteEmpireBuilding", value });
  export const DeleteEmpire = (value: __DeleteEmpireMsg): MessageContentsV2 => ({ tag: "DeleteEmpire", value });
  export const EmpireClaimJoin = (value: __EmpireClaimJoinMsg): MessageContentsV2 => ({ tag: "EmpireClaimJoin", value });
  export const EmpireResupplyNode = (value: __EmpireResupplyNodeMsg): MessageContentsV2 => ({ tag: "EmpireResupplyNode", value });
  export const EmpireDonateItem = (value: __EmpireDonateItemMsg): MessageContentsV2 => ({ tag: "EmpireDonateItem", value });
  export const EmpireCreate = (value: __EmpireCreateMsg): MessageContentsV2 => ({ tag: "EmpireCreate", value });
  export const EmpireCollectHexiteCapsule = (value: __EmpireCollectHexiteCapsuleMsg): MessageContentsV2 => ({ tag: "EmpireCollectHexiteCapsule", value });
  export const EmpireStartSiege = (value: __EmpireStartSiegeMsg): MessageContentsV2 => ({ tag: "EmpireStartSiege", value });
  export const EmpireSiegeAddSupplies = (value: __EmpireSiegeAddSuppliesMsg): MessageContentsV2 => ({ tag: "EmpireSiegeAddSupplies", value });
  export const OnPlayerJoinedEmpire = (value: __OnPlayerJoinedEmpireMsg): MessageContentsV2 => ({ tag: "OnPlayerJoinedEmpire", value });
  export const OnPlayerLeftEmpire = (value: __OnPlayerLeftEmpireMsg): MessageContentsV2 => ({ tag: "OnPlayerLeftEmpire", value });
  export const RegionDestroySiegeEngine = (value: __RegionDestroySiegeEngineMsg): MessageContentsV2 => ({ tag: "RegionDestroySiegeEngine", value });
  export const OnRegionPlayerCreated = (value: __OnRegionPlayerCreatedMsg): MessageContentsV2 => ({ tag: "OnRegionPlayerCreated", value });
  export const EmpireQueueSupplies = (value: __EmpireQueueSuppliesMsg): MessageContentsV2 => ({ tag: "EmpireQueueSupplies", value });
  export const EmpireUpdateEmperorCrown = (value: __EmpireUpdateEmperorCrownMsg): MessageContentsV2 => ({ tag: "EmpireUpdateEmperorCrown", value });
  export const EmpireRemoveCrown = (value: __EmpireRemoveCrownMsg): MessageContentsV2 => ({ tag: "EmpireRemoveCrown", value });
  export const EmpireAddCurrency = (value: __EmpireAddCurrencyMsg): MessageContentsV2 => ({ tag: "EmpireAddCurrency", value });
  export const SignPlayerOut = (value: __SignPlayerOutMsg): MessageContentsV2 => ({ tag: "SignPlayerOut", value });
  export const AdminBroadcastMessage = (value: __AdminBroadcastMessageMsg): MessageContentsV2 => ({ tag: "AdminBroadcastMessage", value });
  export const PlayerSkipQueue = (value: __PlayerSkipQueueMsg): MessageContentsV2 => ({ tag: "PlayerSkipQueue", value });
  export const GrantHubItem = (value: __GrantHubItemMsg): MessageContentsV2 => ({ tag: "GrantHubItem", value });
  export const RecoverDeployable = (value: __RecoverDeployableMsg): MessageContentsV2 => ({ tag: "RecoverDeployable", value });
  export const OnDeployableRecovered = (value: __OnDeployableRecoveredMsg): MessageContentsV2 => ({ tag: "OnDeployableRecovered", value });
  export const ReplaceIdentity = (value: __ReplaceIdentityMsg): MessageContentsV2 => ({ tag: "ReplaceIdentity", value });
  export const ClaimSetName = (value: __ClaimSetNameMsg): MessageContentsV2 => ({ tag: "ClaimSetName", value });
  export const RestoreSkills = (value: __RestoreSkillsMsg): MessageContentsV2 => ({ tag: "RestoreSkills", value });
  export const NpcPlaceWatchtowers = (value: __NpcPlaceWatchtowersMsg): MessageContentsV2 => ({ tag: "NpcPlaceWatchtowers", value });
  export const EmpireWithdrawItem = (value: __EmpireWithdrawItemMsg): MessageContentsV2 => ({ tag: "EmpireWithdrawItem", value });

  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createSumType([
      new SumTypeVariant("TableUpdate", __InterModuleTableUpdates.getTypeScriptAlgebraicType()),
      new SumTypeVariant("TransferPlayerRequest", __TransferPlayerMsgV2.getTypeScriptAlgebraicType()),
  ...
  export function serialize(writer: BinaryWriter, value: MessageContentsV2): void {
      MessageContentsV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): MessageContentsV2 {
      return MessageContentsV2.getTypeScriptAlgebraicType().deserialize(reader);
  }

}

// The tagged union or sum type for the algebraic type `MessageContentsV2`.
export type MessageContentsV2 = MessageContentsV2.TableUpdate | MessageContentsV2.TransferPlayerRequest | MessageContentsV2.TransferPlayerHousingRequest | MessageContentsV2.PlayerCreateRequest | MessageContentsV2.UserUpdateRegionRequest | MessageContentsV2.OnPlayerNameSetRequest | MessageContentsV2.ClaimCreateEmpireSettlementState | MessageContentsV2.OnClaimMembersChanged | MessageContentsV2.EmpireCreateBuilding | MessageContentsV2.OnEmpireBuildingDeleted | MessageContentsV2.GlobalDeleteEmpireBuilding | MessageContentsV2.DeleteEmpire | MessageContentsV2.EmpireClaimJoin | MessageContentsV2.EmpireResupplyNode | MessageContentsV2.EmpireDonateItem | MessageContentsV2.EmpireCreate | MessageContentsV2.EmpireCollectHexiteCapsule | MessageContentsV2.EmpireStartSiege | MessageContentsV2.EmpireSiegeAddSupplies | MessageContentsV2.OnPlayerJoinedEmpire | MessageContentsV2.OnPlayerLeftEmpire | MessageContentsV2.RegionDestroySiegeEngine | MessageContentsV2.OnRegionPlayerCreated | MessageContentsV2.EmpireQueueSupplies | MessageContentsV2.EmpireUpdateEmperorCrown | MessageContentsV2.EmpireRemoveCrown | MessageContentsV2.EmpireAddCurrency | MessageContentsV2.SignPlayerOut | MessageContentsV2.AdminBroadcastMessage | MessageContentsV2.PlayerSkipQueue | MessageContentsV2.GrantHubItem | MessageContentsV2.RecoverDeployable | MessageContentsV2.OnDeployableRecovered | MessageContentsV2.ReplaceIdentity | MessageContentsV2.ClaimSetName | MessageContentsV2.RestoreSkills | MessageContentsV2.NpcPlaceWatchtowers | MessageContentsV2.EmpireWithdrawItem;
