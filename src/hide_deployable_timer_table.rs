...
/// Lifetime-aware accessor marker for the table `hide_deployable_timer`.
pub struct HideDeployableTimerTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for HideDeployableTimerTableAccessor {
    type Row = HideDeployableTimer;
    type Handle<'db> = HideDeployableTimerTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.hide_deployable_timer()
    }
}
...
impl<'ctx> __sdk::TableLike for HideDeployableTimerTableHandle<'ctx> {
    type Row = HideDeployableTimer;
...
impl<'ctx> __sdk::WithInsert for HideDeployableTimerTableHandle<'ctx> {
    type InsertCallbackId = HideDeployableTimerInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for HideDeployableTimerTableHandle<'ctx> {
    type DeleteCallbackId = HideDeployableTimerDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for HideDeployableTimerTableHandle<'ctx> {
    type UpdateCallbackId = HideDeployableTimerUpdateCallbackId;
