...
pub trait trade_add_item {
    ...
    fn on_trade_add_item(&self, callback: impl FnMut(&super::ReducerEventContext, &PlayerTradeAddItemRequest, ) + Send + 'static) -> TradeAddItemCallbackId;
...
impl trade_add_item for super::RemoteReducers {
    fn trade_add_item(&self, request: PlayerTradeAddItemRequest,
        ...
        self.imp.call_reducer("trade_add_item", TradeAddItemArgs { request,  })
    }
    fn on_trade_add_item(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &PlayerTradeAddItemRequest, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::TradeAddItem {
                            request, 
                        },
                        ..
                    },
