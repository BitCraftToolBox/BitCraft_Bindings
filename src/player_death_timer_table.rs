...
/// Lifetime-aware accessor marker for the table `player_death_timer`.
pub struct PlayerDeathTimerTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for PlayerDeathTimerTableAccessor {
    type Row = PlayerDeathTimer;
    type Handle<'db> = PlayerDeathTimerTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.player_death_timer()
    }
}
...
impl<'ctx> __sdk::TableLike for PlayerDeathTimerTableHandle<'ctx> {
    type Row = PlayerDeathTimer;
...
impl<'ctx> __sdk::WithInsert for PlayerDeathTimerTableHandle<'ctx> {
    type InsertCallbackId = PlayerDeathTimerInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for PlayerDeathTimerTableHandle<'ctx> {
    type DeleteCallbackId = PlayerDeathTimerDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for PlayerDeathTimerTableHandle<'ctx> {
    type UpdateCallbackId = PlayerDeathTimerUpdateCallbackId;
