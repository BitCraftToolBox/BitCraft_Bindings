...
new_message_text: String,
    ...
    fn on_admin_modify_chat_message(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &String, ) + Send + 'static) -> AdminModifyChatMessageCallbackId;
...
new_message_text: String,
        ...
        self.imp.call_reducer("admin_modify_chat_message", AdminModifyChatMessageArgs { entity_id, new_message_text,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminModifyChatMessage {
                            entity_id, new_message_text, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_admin_modify_chat_message(&self, callback: AdminModifyChatMessageCallbackId) {
        self.imp.remove_on_reducer("admin_modify_chat_message", callback.0)
    }
}
...
impl set_flags_for_admin_modify_chat_message for super::SetReducerFlags {
    fn admin_modify_chat_message(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_modify_chat_message", flags);
    }
}
