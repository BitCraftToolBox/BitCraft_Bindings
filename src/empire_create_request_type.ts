...
export type EmpireCreateRequest = {
 ...
 */
export namespace EmpireCreateRequest {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: EmpireCreateRequest): void {
    EmpireCreateRequest.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): EmpireCreateRequest {
    return EmpireCreateRequest.getTypeScriptAlgebraicType().deserialize(reader);
  }
