...
pub trait cheat_deployable_store {
    ...
    fn on_cheat_deployable_store(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> CheatDeployableStoreCallbackId;
...
impl cheat_deployable_store for super::RemoteReducers {
    fn cheat_deployable_store(&self, deployable_entity_id: u64,
        ...
        self.imp.call_reducer("cheat_deployable_store", CheatDeployableStoreArgs { deployable_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatDeployableStore {
    ...
    fn remove_on_cheat_deployable_store(&self, callback: CheatDeployableStoreCallbackId) {
        self.imp.remove_on_reducer("cheat_deployable_store", callback.0)
    }
}
...
impl set_flags_for_cheat_deployable_store for super::SetReducerFlags {
    fn cheat_deployable_store(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("cheat_deployable_store", flags);
    }
}
