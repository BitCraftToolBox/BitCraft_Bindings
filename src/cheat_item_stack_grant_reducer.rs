...
is_cargo: bool,
    ...
    fn on_cheat_item_stack_grant(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, &i32, &i32, &bool, ) + Send + 'static) -> CheatItemStackGrantCallbackId;
...
is_cargo: bool,
        ...
        self.imp.call_reducer("cheat_item_stack_grant", CheatItemStackGrantArgs { player_entity_id, item_id, quantity, is_cargo,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatItemStackGrant {
    ...
    fn remove_on_cheat_item_stack_grant(&self, callback: CheatItemStackGrantCallbackId) {
        self.imp.remove_on_reducer("cheat_item_stack_grant", callback.0)
    }
}
...
impl set_flags_for_cheat_item_stack_grant for super::SetReducerFlags {
    fn cheat_item_stack_grant(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("cheat_item_stack_grant", flags);
    }
}
