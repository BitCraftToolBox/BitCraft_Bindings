 ...
 */
export namespace ClaimTechDescV2 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: ClaimTechDescV2): void {
    ClaimTechDescV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): ClaimTechDescV2 {
    return ClaimTechDescV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
