 ...
 *
 * Obtain a handle from the [`stagedDeconstructionRecipeDesc`] property on [`RemoteTables`],
 * like `ctx.db.stagedDeconstructionRecipeDesc`.
 *
 * Users are encouraged not to explicitly reference this type,
 * but to directly chain method calls,
 * like `ctx.db.stagedDeconstructionRecipeDesc.on_insert(...)`.
 */
export class StagedDeconstructionRecipeDescTableHandle {
   ...
   * Users are encouraged not to explicitly reference this type,
   * but to directly chain method calls,
   * like `ctx.db.stagedDeconstructionRecipeDesc.id().find(...)`.
   *
