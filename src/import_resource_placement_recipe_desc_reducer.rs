...
pub trait import_resource_placement_recipe_desc {
    ...
    fn on_import_resource_placement_recipe_desc(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<ResourcePlacementRecipeDesc>, ) + Send + 'static) -> ImportResourcePlacementRecipeDescCallbackId;
    /// Cancel a callback previously registered by [`Self::on_import_resource_placement_recipe_desc`],
    /// causing it not to run in the future.
    fn remove_on_import_resource_placement_recipe_desc(&self, callback: ImportResourcePlacementRecipeDescCallbackId);
}

impl import_resource_placement_recipe_desc for super::RemoteReducers {
    fn import_resource_placement_recipe_desc(&self, records: Vec::<ResourcePlacementRecipeDesc>,
) -> __sdk::Result<()> {
        self.imp.call_reducer("import_resource_placement_recipe_desc", ImportResourcePlacementRecipeDescArgs { records,  })
    }
    fn on_import_resource_placement_recipe_desc(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &Vec::<ResourcePlacementRecipeDesc>, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportResourcePlacementRecipeDesc {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_import_resource_placement_recipe_desc(&self, callback: ImportResourcePlacementRecipeDescCallbackId) {
        self.imp.remove_on_reducer("import_resource_placement_recipe_desc", callback.0)
    }
}
...
impl set_flags_for_import_resource_placement_recipe_desc for super::SetReducerFlags {
    fn import_resource_placement_recipe_desc(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("import_resource_placement_recipe_desc", flags);
    }
}
