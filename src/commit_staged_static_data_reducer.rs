...
pub trait commit_staged_static_data {
    ...
    fn on_commit_staged_static_data(&self, callback: impl FnMut(&super::ReducerEventContext, ) + Send + 'static) -> CommitStagedStaticDataCallbackId;
...
impl commit_staged_static_data for super::RemoteReducers {
    fn commit_staged_static_data(&self, ) -> __sdk::Result<()> {
        self.imp.call_reducer("commit_staged_static_data", CommitStagedStaticDataArgs {  })
    }
    ...
    fn remove_on_commit_staged_static_data(&self, callback: CommitStagedStaticDataCallbackId) {
        self.imp.remove_on_reducer("commit_staged_static_data", callback.0)
    }
}
...
impl set_flags_for_commit_staged_static_data for super::SetReducerFlags {
    fn commit_staged_static_data(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("commit_staged_static_data", flags);
    }
}
