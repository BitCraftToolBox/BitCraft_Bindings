...
pub trait admin_collapse_ruin {
    ...
    fn on_admin_collapse_ruin(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> AdminCollapseRuinCallbackId;
...
impl admin_collapse_ruin for super::RemoteReducers {
    fn admin_collapse_ruin(&self, ruin_building_entity_id: u64,
        ...
        self.imp.call_reducer("admin_collapse_ruin", AdminCollapseRuinArgs { ruin_building_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminCollapseRuin {
    ...
    fn remove_on_admin_collapse_ruin(&self, callback: AdminCollapseRuinCallbackId) {
        self.imp.remove_on_reducer("admin_collapse_ruin", callback.0)
    }
}
...
impl set_flags_for_admin_collapse_ruin for super::SetReducerFlags {
    fn admin_collapse_ruin(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_collapse_ruin", flags);
    }
}
