...
export type ParametersDesc = {
  ...
  empireStartingCurrency: number,
  empireRenameCurrencyCost: number,
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("empireStartingCurrency", AlgebraicType.createU32Type()),
      new ProductTypeElement("empireRenameCurrencyCost", AlgebraicType.createU32Type()),
