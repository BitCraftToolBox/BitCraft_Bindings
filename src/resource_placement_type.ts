 ...
 */
export namespace ResourcePlacement {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: ResourcePlacement): void {
    ResourcePlacement.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): ResourcePlacement {
    return ResourcePlacement.getTypeScriptAlgebraicType().deserialize(reader);
  }
