...
/// Lifetime-aware accessor marker for the table `user_authentication_state`.
pub struct UserAuthenticationStateTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for UserAuthenticationStateTableAccessor {
    type Row = UserAuthenticationState;
    type Handle<'db> = UserAuthenticationStateTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.user_authentication_state()
    }
}
...
impl<'ctx> __sdk::TableLike for UserAuthenticationStateTableHandle<'ctx> {
    type Row = UserAuthenticationState;
...
impl<'ctx> __sdk::WithInsert for UserAuthenticationStateTableHandle<'ctx> {
    type InsertCallbackId = UserAuthenticationStateInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for UserAuthenticationStateTableHandle<'ctx> {
    type DeleteCallbackId = UserAuthenticationStateDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for UserAuthenticationStateTableHandle<'ctx> {
    type UpdateCallbackId = UserAuthenticationStateUpdateCallbackId;
