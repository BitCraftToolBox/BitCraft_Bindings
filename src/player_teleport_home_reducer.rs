...
pub trait player_teleport_home {
    ...
    fn on_player_teleport_home(&self, callback: impl FnMut(&super::ReducerEventContext, &PlayerTeleportHomeRequest, ) + Send + 'static) -> PlayerTeleportHomeCallbackId;
...
impl player_teleport_home for super::RemoteReducers {
    fn player_teleport_home(&self, request: PlayerTeleportHomeRequest,
        ...
        self.imp.call_reducer("player_teleport_home", PlayerTeleportHomeArgs { request,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::PlayerTeleportHome {
                            request, 
                        },
                        ..
                    },
    ...
    fn remove_on_player_teleport_home(&self, callback: PlayerTeleportHomeCallbackId) {
        self.imp.remove_on_reducer("player_teleport_home", callback.0)
    }
}
...
impl set_flags_for_player_teleport_home for super::SetReducerFlags {
    fn player_teleport_home(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("player_teleport_home", flags);
    }
}
