...
export type TransferPlayerMsgV4 = {
 ...
 */
export namespace TransferPlayerMsgV4 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: TransferPlayerMsgV4): void {
    TransferPlayerMsgV4.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): TransferPlayerMsgV4 {
    return TransferPlayerMsgV4.getTypeScriptAlgebraicType().deserialize(reader);
  }
