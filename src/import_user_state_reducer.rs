...
pub trait import_user_state {
    ...
    fn on_import_user_state(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<UserState>, ) + Send + 'static) -> ImportUserStateCallbackId;
...
impl import_user_state for super::RemoteReducers {
    fn import_user_state(&self, records: Vec::<UserState>,
        ...
        self.imp.call_reducer("import_user_state", ImportUserStateArgs { records,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportUserState {
                            records, 
                        },
                        ..
                    },
