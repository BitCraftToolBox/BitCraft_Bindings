...
pub trait admin_update_housing_portals {
    ...
    fn on_admin_update_housing_portals(&self, callback: impl FnMut(&super::ReducerEventContext, ) + Send + 'static) -> AdminUpdateHousingPortalsCallbackId;
...
impl admin_update_housing_portals for super::RemoteReducers {
    fn admin_update_housing_portals(&self, ) -> __sdk::Result<()> {
        self.imp.call_reducer("admin_update_housing_portals", AdminUpdateHousingPortalsArgs {  })
    }
    ...
    fn remove_on_admin_update_housing_portals(&self, callback: AdminUpdateHousingPortalsCallbackId) {
        self.imp.remove_on_reducer("admin_update_housing_portals", callback.0)
    }
}
...
impl set_flags_for_admin_update_housing_portals for super::SetReducerFlags {
    fn admin_update_housing_portals(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_update_housing_portals", flags);
    }
}
