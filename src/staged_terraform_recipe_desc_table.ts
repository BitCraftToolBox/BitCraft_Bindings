 ...
 *
 * Obtain a handle from the [`stagedTerraformRecipeDesc`] property on [`RemoteTables`],
 * like `ctx.db.stagedTerraformRecipeDesc`.
 *
 * Users are encouraged not to explicitly reference this type,
 * but to directly chain method calls,
 * like `ctx.db.stagedTerraformRecipeDesc.on_insert(...)`.
 */
export class StagedTerraformRecipeDescTableHandle {
   ...
   * Users are encouraged not to explicitly reference this type,
   * but to directly chain method calls,
   * like `ctx.db.stagedTerraformRecipeDesc.difference().find(...)`.
   *
