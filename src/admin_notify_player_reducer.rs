...
message: String,
    ...
    fn on_admin_notify_player(&self, callback: impl FnMut(&super::ReducerEventContext, &String, &String, &String, ) + Send + 'static) -> AdminNotifyPlayerCallbackId;
...
message: String,
        ...
        self.imp.call_reducer("admin_notify_player", AdminNotifyPlayerArgs { username, title, message,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminNotifyPlayer {
    ...
    fn remove_on_admin_notify_player(&self, callback: AdminNotifyPlayerCallbackId) {
        self.imp.remove_on_reducer("admin_notify_player", callback.0)
    }
}
...
impl set_flags_for_admin_notify_player for super::SetReducerFlags {
    fn admin_notify_player(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_notify_player", flags);
    }
}
