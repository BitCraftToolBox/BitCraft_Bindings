...
/// Lifetime-aware accessor marker for the table `unclaimed_collectibles_state`.
pub struct UnclaimedCollectiblesStateTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for UnclaimedCollectiblesStateTableAccessor {
    type Row = UnclaimedCollectiblesState;
    type Handle<'db> = UnclaimedCollectiblesStateTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.unclaimed_collectibles_state()
    }
}
...
impl<'ctx> __sdk::TableLike for UnclaimedCollectiblesStateTableHandle<'ctx> {
    type Row = UnclaimedCollectiblesState;
...
impl<'ctx> __sdk::WithInsert for UnclaimedCollectiblesStateTableHandle<'ctx> {
    type InsertCallbackId = UnclaimedCollectiblesStateInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for UnclaimedCollectiblesStateTableHandle<'ctx> {
    type DeleteCallbackId = UnclaimedCollectiblesStateDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for UnclaimedCollectiblesStateTableHandle<'ctx> {
    type UpdateCallbackId = UnclaimedCollectiblesStateUpdateCallbackId;
