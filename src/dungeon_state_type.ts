...
export namespace DungeonState {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: DungeonState): void {
    DungeonState.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): DungeonState {
    return DungeonState.getTypeScriptAlgebraicType().deserialize(reader);
  }
