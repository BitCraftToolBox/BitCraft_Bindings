...
pub trait admin_alpha_3_reset_onboarding_to_second_temple_quest {
    ...
    fn on_admin_alpha_3_reset_onboarding_to_second_temple_quest(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> AdminAlpha3ResetOnboardingToSecondTempleQuestCallbackId;
    /// Cancel a callback previously registered by [`Self::on_admin_alpha_3_reset_onboarding_to_second_temple_quest`],
    /// causing it not to run in the future.
    fn remove_on_admin_alpha_3_reset_onboarding_to_second_temple_quest(&self, callback: AdminAlpha3ResetOnboardingToSecondTempleQuestCallbackId);
}

impl admin_alpha_3_reset_onboarding_to_second_temple_quest for super::RemoteReducers {
    fn admin_alpha_3_reset_onboarding_to_second_temple_quest(&self, entity_id: u64,
) -> __sdk::Result<()> {
        self.imp.call_reducer("admin_alpha3_reset_onboarding_to_second_temple_quest", AdminAlpha3ResetOnboardingToSecondTempleQuestArgs { entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminAlpha3ResetOnboardingToSecondTempleQuest {
                            entity_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_admin_alpha_3_reset_onboarding_to_second_temple_quest(&self, callback: AdminAlpha3ResetOnboardingToSecondTempleQuestCallbackId) {
        self.imp.remove_on_reducer("admin_alpha3_reset_onboarding_to_second_temple_quest", callback.0)
    }
}
...
impl set_flags_for_admin_alpha_3_reset_onboarding_to_second_temple_quest for super::SetReducerFlags {
    fn admin_alpha_3_reset_onboarding_to_second_temple_quest(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_alpha3_reset_onboarding_to_second_temple_quest", flags);
    }
}
