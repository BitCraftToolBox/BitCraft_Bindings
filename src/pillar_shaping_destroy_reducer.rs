...
pub trait pillar_shaping_destroy {
    ...
    fn on_pillar_shaping_destroy(&self, callback: impl FnMut(&super::ReducerEventContext, &PlayerPillarShapingDestroyRequest, ) + Send + 'static) -> PillarShapingDestroyCallbackId;
...
impl pillar_shaping_destroy for super::RemoteReducers {
    fn pillar_shaping_destroy(&self, request: PlayerPillarShapingDestroyRequest,
        ...
        self.imp.call_reducer("pillar_shaping_destroy", PillarShapingDestroyArgs { request,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::PillarShapingDestroy {
                            request, 
                        },
                        ..
                    },
    ...
    fn remove_on_pillar_shaping_destroy(&self, callback: PillarShapingDestroyCallbackId) {
        self.imp.remove_on_reducer("pillar_shaping_destroy", callback.0)
    }
}
...
impl set_flags_for_pillar_shaping_destroy for super::SetReducerFlags {
    fn pillar_shaping_destroy(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("pillar_shaping_destroy", flags);
    }
}
