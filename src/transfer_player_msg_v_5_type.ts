...
import { EquipmentPresetState as __EquipmentPresetState } from "./equipment_preset_state_type";
...
import { TravelerTaskCreditState as __TravelerTaskCreditState } from "./traveler_task_credit_state_type";

export type TransferPlayerMsgV5 = {
  originalLocation: __FloatHexTileMessage,
  destinationLocation: __FloatHexTileMessage,
  allowCancel: boolean,
  teleportEnergyCost: number,
  vehicle: __DeployableStateV2 | undefined,
  ...
  equipmentPresetState: __EquipmentPresetState[],
  ...
  explorationChunksState: __ExplorationChunksStateV2,
  ...
  travelerTaskCreditStates: __TravelerTaskCreditState[],
  undeployedDeployableStates: __DeployableStateV2[],
 ...
 */
export namespace TransferPlayerMsgV5 {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("vehicle", AlgebraicType.createOptionType(__DeployableStateV2.getTypeScriptAlgebraicType())),
      ...
      new ProductTypeElement("equipmentPresetState", AlgebraicType.createArrayType(__EquipmentPresetState.getTypeScriptAlgebraicType())),
      ...
      new ProductTypeElement("explorationChunksState", __ExplorationChunksStateV2.getTypeScriptAlgebraicType()),
      ...
      new ProductTypeElement("travelerTaskCreditStates", AlgebraicType.createArrayType(__TravelerTaskCreditState.getTypeScriptAlgebraicType())),
      new ProductTypeElement("undeployedDeployableStates", AlgebraicType.createArrayType(__DeployableStateV2.getTypeScriptAlgebraicType())),
  ...
  export function serialize(writer: BinaryWriter, value: TransferPlayerMsgV5): void {
    TransferPlayerMsgV5.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): TransferPlayerMsgV5 {
    return TransferPlayerMsgV5.getTypeScriptAlgebraicType().deserialize(reader);
  }
