...
balance: u32,
    ...
    fn on_admin_update_granted_hub_item_state(&self, callback: impl FnMut(&super::ReducerEventContext, &__sdk::Identity, &HubItemType, &i32, &u32, ) + Send + 'static) -> AdminUpdateGrantedHubItemStateCallbackId;
    /// Cancel a callback previously registered by [`Self::on_admin_update_granted_hub_item_state`],
    /// causing it not to run in the future.
    fn remove_on_admin_update_granted_hub_item_state(&self, callback: AdminUpdateGrantedHubItemStateCallbackId);
}
...
balance: u32,
        ...
        self.imp.call_reducer("admin_update_granted_hub_item_state", AdminUpdateGrantedHubItemStateArgs { identity, item_type, item_id, balance,  })
    }
    fn on_admin_update_granted_hub_item_state(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &__sdk::Identity, &HubItemType, &i32, &u32, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminUpdateGrantedHubItemState {
                            identity, item_type, item_id, balance, 
                        },
                        ..
                    },
                    ..
    ...
    fn remove_on_admin_update_granted_hub_item_state(&self, callback: AdminUpdateGrantedHubItemStateCallbackId) {
        self.imp.remove_on_reducer("admin_update_granted_hub_item_state", callback.0)
    }
}
...
impl set_flags_for_admin_update_granted_hub_item_state for super::SetReducerFlags {
    fn admin_update_granted_hub_item_state(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("admin_update_granted_hub_item_state", flags);
    }
}
