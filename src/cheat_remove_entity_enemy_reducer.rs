...
pub trait cheat_remove_entity_enemy {
    ...
    fn on_cheat_remove_entity_enemy(&self, callback: impl FnMut(&super::ReducerEventContext, &u64, ) + Send + 'static) -> CheatRemoveEntityEnemyCallbackId;
...
impl cheat_remove_entity_enemy for super::RemoteReducers {
    fn cheat_remove_entity_enemy(&self, enemy_entity_id: u64,
        ...
        self.imp.call_reducer("cheat_remove_entity_enemy", CheatRemoveEntityEnemyArgs { enemy_entity_id,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::CheatRemoveEntityEnemy {
                            enemy_entity_id, 
                        },
                        ..
                    },
    ...
    fn remove_on_cheat_remove_entity_enemy(&self, callback: CheatRemoveEntityEnemyCallbackId) {
        self.imp.remove_on_reducer("cheat_remove_entity_enemy", callback.0)
    }
}
...
impl set_flags_for_cheat_remove_entity_enemy for super::SetReducerFlags {
    fn cheat_remove_entity_enemy(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("cheat_remove_entity_enemy", flags);
    }
}
