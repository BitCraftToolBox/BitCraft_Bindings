...
pub trait import_interior_portal_connections_desc {
    ...
    fn on_import_interior_portal_connections_desc(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<InteriorPortalConnectionsDesc>, ) + Send + 'static) -> ImportInteriorPortalConnectionsDescCallbackId;
    /// Cancel a callback previously registered by [`Self::on_import_interior_portal_connections_desc`],
    /// causing it not to run in the future.
    fn remove_on_import_interior_portal_connections_desc(&self, callback: ImportInteriorPortalConnectionsDescCallbackId);
}

impl import_interior_portal_connections_desc for super::RemoteReducers {
    fn import_interior_portal_connections_desc(&self, records: Vec::<InteriorPortalConnectionsDesc>,
) -> __sdk::Result<()> {
        self.imp.call_reducer("import_interior_portal_connections_desc", ImportInteriorPortalConnectionsDescArgs { records,  })
    }
    fn on_import_interior_portal_connections_desc(
        ...
        ImportInteriorPortalConnectionsDescCallbackId(self.imp.on_reducer(
            "import_interior_portal_connections_desc",
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::ImportInteriorPortalConnectionsDesc {
                            records, 
                        },
                        ..
                    },
    ...
    fn remove_on_import_interior_portal_connections_desc(&self, callback: ImportInteriorPortalConnectionsDescCallbackId) {
        self.imp.remove_on_reducer("import_interior_portal_connections_desc", callback.0)
    }
}
...
impl set_flags_for_import_interior_portal_connections_desc for super::SetReducerFlags {
    fn import_interior_portal_connections_desc(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("import_interior_portal_connections_desc", flags);
    }
}
