...
pub trait pillar_shaping_place_pillar_start {
    ...
    fn on_pillar_shaping_place_pillar_start(&self, callback: impl FnMut(&super::ReducerEventContext, &PlayerPillarShapingPlaceRequest, ) + Send + 'static) -> PillarShapingPlacePillarStartCallbackId;
    /// Cancel a callback previously registered by [`Self::on_pillar_shaping_place_pillar_start`],
    /// causing it not to run in the future.
    fn remove_on_pillar_shaping_place_pillar_start(&self, callback: PillarShapingPlacePillarStartCallbackId);
}

impl pillar_shaping_place_pillar_start for super::RemoteReducers {
    fn pillar_shaping_place_pillar_start(&self, request: PlayerPillarShapingPlaceRequest,
) -> __sdk::Result<()> {
        self.imp.call_reducer("pillar_shaping_place_pillar_start", PillarShapingPlacePillarStartArgs { request,  })
    }
    fn on_pillar_shaping_place_pillar_start(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &PlayerPillarShapingPlaceRequest, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::PillarShapingPlacePillarStart {
                            request, 
                        },
                        ..
                    },
    ...
    fn remove_on_pillar_shaping_place_pillar_start(&self, callback: PillarShapingPlacePillarStartCallbackId) {
        self.imp.remove_on_reducer("pillar_shaping_place_pillar_start", callback.0)
    }
}
...
impl set_flags_for_pillar_shaping_place_pillar_start for super::SetReducerFlags {
    fn pillar_shaping_place_pillar_start(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("pillar_shaping_place_pillar_start", flags);
    }
}
