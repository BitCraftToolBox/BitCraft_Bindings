...
/// Lifetime-aware accessor marker for the table `transfer_player_timer`.
pub struct TransferPlayerTimerTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for TransferPlayerTimerTableAccessor {
    type Row = TransferPlayerTimer;
    type Handle<'db> = TransferPlayerTimerTableHandle<'db>;

    fn get<'db>(db: &'db super::RemoteTables) -> Self::Handle<'db> {
        db.transfer_player_timer()
    }
}
...
impl<'ctx> __sdk::TableLike for TransferPlayerTimerTableHandle<'ctx> {
    type Row = TransferPlayerTimer;
...
impl<'ctx> __sdk::WithInsert for TransferPlayerTimerTableHandle<'ctx> {
    type InsertCallbackId = TransferPlayerTimerInsertCallbackId;
...
impl<'ctx> __sdk::WithDelete for TransferPlayerTimerTableHandle<'ctx> {
    type DeleteCallbackId = TransferPlayerTimerDeleteCallbackId;
...
impl<'ctx> __sdk::WithUpdate for TransferPlayerTimerTableHandle<'ctx> {
    type UpdateCallbackId = TransferPlayerTimerUpdateCallbackId;
