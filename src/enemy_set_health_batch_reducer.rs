...
pub trait enemy_set_health_batch {
    ...
    fn on_enemy_set_health_batch(&self, callback: impl FnMut(&super::ReducerEventContext, &Vec::<EnemySetHealthRequest>, ) + Send + 'static) -> EnemySetHealthBatchCallbackId;
...
impl enemy_set_health_batch for super::RemoteReducers {
    fn enemy_set_health_batch(&self, requests: Vec::<EnemySetHealthRequest>,
        ...
        self.imp.call_reducer("enemy_set_health_batch", EnemySetHealthBatchArgs { requests,  })
    }
    fn on_enemy_set_health_batch(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &Vec::<EnemySetHealthRequest>, ) + Send + 'static,
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::EnemySetHealthBatch {
                            requests, 
                        },
                        ..
                    },
    ...
    fn remove_on_enemy_set_health_batch(&self, callback: EnemySetHealthBatchCallbackId) {
        self.imp.remove_on_reducer("enemy_set_health_batch", callback.0)
    }
}
...
impl set_flags_for_enemy_set_health_batch for super::SetReducerFlags {
    fn enemy_set_health_batch(&self, flags: __ws::CallReducerFlags) {
        self.imp.set_call_reducer_flags("enemy_set_health_batch", flags);
    }
}
