...
amount: i32,
    ...
    fn on_admin_grant_shards(&self, callback: impl FnMut(&super::ReducerEventContext, &String, &i32, ) + Send + 'static) -> AdminGrantShardsCallbackId;
...
amount: i32,
        ...
        self.imp.call_reducer("admin_grant_shards", AdminGrantShardsArgs { identity, amount,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::AdminGrantShards {
                            identity, amount, 
                        },
                        ..
                    },
