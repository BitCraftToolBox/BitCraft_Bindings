...
export type DeployableStateV2 = {
  ...
  nickname: string,
  hidden: boolean,
  appearanceOverrideId: number,
};

/**
 * A namespace for generated helper functions.
 */
export namespace DeployableStateV2 {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("appearanceOverrideId", AlgebraicType.createI32Type()),
    ]);
  }

  export function serialize(writer: BinaryWriter, value: DeployableStateV2): void {
    DeployableStateV2.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): DeployableStateV2 {
    return DeployableStateV2.getTypeScriptAlgebraicType().deserialize(reader);
  }
