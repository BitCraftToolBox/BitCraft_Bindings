 ...
 *
 * Obtain a handle from the [`stagedLootRarityDesc`] property on [`RemoteTables`],
 * like `ctx.db.stagedLootRarityDesc`.
 *
 * Users are encouraged not to explicitly reference this type,
 * but to directly chain method calls,
 * like `ctx.db.stagedLootRarityDesc.on_insert(...)`.
 */
export class StagedLootRarityDescTableHandle {
   ...
   * Users are encouraged not to explicitly reference this type,
   * but to directly chain method calls,
   * like `ctx.db.stagedLootRarityDesc.id().find(...)`.
   *
