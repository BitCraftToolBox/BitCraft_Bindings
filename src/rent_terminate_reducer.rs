...
pub trait rent_terminate {
    ...
    fn on_rent_terminate(&self, callback: impl FnMut(&super::ReducerEventContext, &RentTerminateRequest, ) + Send + 'static) -> RentTerminateCallbackId;
...
impl rent_terminate for super::RemoteReducers {
    fn rent_terminate(&self, request: RentTerminateRequest,
        ...
        self.imp.call_reducer("rent_terminate", RentTerminateArgs { request,  })
    }
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event: __sdk::ReducerEvent {
                        reducer: super::Reducer::RentTerminate {
                            request, 
                        },
                        ..
                    },
