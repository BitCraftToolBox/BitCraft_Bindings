 ...
 */
export namespace DeployableDescV4 {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: DeployableDescV4): void {
    DeployableDescV4.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): DeployableDescV4 {
    return DeployableDescV4.getTypeScriptAlgebraicType().deserialize(reader);
  }
