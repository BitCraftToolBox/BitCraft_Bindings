...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportLootChestDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.LootChestDesc> records);
        public event ImportLootChestDescHandler? OnImportLootChestDesc;

        public void ImportLootChestDesc(System.Collections.Generic.List<BitCraftRegion.Types.LootChestDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportLootChestDesc(records));
        }
