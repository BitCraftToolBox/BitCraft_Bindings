...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportLootChestDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.LootChestDesc> records);
        public event ImportLootChestDescHandler? OnImportLootChestDesc;

        public void ImportLootChestDesc(System.Collections.Generic.List<BitCraftGlobal.Types.LootChestDesc> records)
        {
