...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void StageElevatorDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.ElevatorDesc> records);
        public event StageElevatorDescHandler? OnStageElevatorDesc;

        public void StageElevatorDesc(System.Collections.Generic.List<BitCraftRegion.Types.ElevatorDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageElevatorDesc(records));
        }
