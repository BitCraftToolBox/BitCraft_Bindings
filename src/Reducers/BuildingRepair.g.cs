...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void BuildingRepairHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerBuildingRepairRequest request);
        public event BuildingRepairHandler? OnBuildingRepair;

        public void BuildingRepair(BitCraftRegion.Types.PlayerBuildingRepairRequest request)
        {
            conn.InternalCallReducer(new Reducer.BuildingRepair(request));
        }
