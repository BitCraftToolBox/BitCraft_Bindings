...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageCombatActionMultiHitDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.CombatActionMultiHitDesc> records);
        public event StageCombatActionMultiHitDescHandler? OnStageCombatActionMultiHitDesc;

        public void StageCombatActionMultiHitDesc(System.Collections.Generic.List<BitCraftGlobal.Types.CombatActionMultiHitDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageCombatActionMultiHitDesc(records));
        }
