...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportHerdCacheHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.HerdState> records);
        public event ImportHerdCacheHandler? OnImportHerdCache;

        public void ImportHerdCache(System.Collections.Generic.List<BitCraftRegion.Types.HerdState> records)
        {
            conn.InternalCallReducer(new Reducer.ImportHerdCache(records));
        }
