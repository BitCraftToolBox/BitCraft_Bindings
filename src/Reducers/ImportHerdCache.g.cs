...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportHerdCacheHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.HerdState> records);
        public event ImportHerdCacheHandler? OnImportHerdCache;

        public void ImportHerdCache(System.Collections.Generic.List<BitCraftGlobal.Types.HerdState> records)
        {
