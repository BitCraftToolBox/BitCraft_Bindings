...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportCombatActionMultiHitDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.CombatActionMultiHitDesc> records);
        public event ImportCombatActionMultiHitDescHandler? OnImportCombatActionMultiHitDesc;

        public void ImportCombatActionMultiHitDesc(System.Collections.Generic.List<BitCraftRegion.Types.CombatActionMultiHitDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportCombatActionMultiHitDesc(records));
        }
