...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageToolTypeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.ToolTypeDesc> records);
        public event StageToolTypeDescHandler? OnStageToolTypeDesc;

        public void StageToolTypeDesc(System.Collections.Generic.List<BitCraftGlobal.Types.ToolTypeDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageToolTypeDesc(records));
        }
