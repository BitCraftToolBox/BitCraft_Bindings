...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void TransferPlayerDelayedHandler(ReducerEventContext ctx, BitCraftRegion.Types.TransferPlayerTimer timer);
        public event TransferPlayerDelayedHandler? OnTransferPlayerDelayed;

        public void TransferPlayerDelayed(BitCraftRegion.Types.TransferPlayerTimer timer)
        {
            conn.InternalCallReducer(new Reducer.TransferPlayerDelayed(timer));
        }
