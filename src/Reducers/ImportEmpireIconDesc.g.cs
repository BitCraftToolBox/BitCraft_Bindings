...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportEmpireIconDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.EmpireIconDesc> records);
        public event ImportEmpireIconDescHandler? OnImportEmpireIconDesc;

        public void ImportEmpireIconDesc(System.Collections.Generic.List<BitCraftRegion.Types.EmpireIconDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportEmpireIconDesc(records));
        }
