...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ClaimSetMemberPermissionsHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerClaimSetMemberPermissionsRequest request);
        public event ClaimSetMemberPermissionsHandler? OnClaimSetMemberPermissions;

        public void ClaimSetMemberPermissions(BitCraftRegion.Types.PlayerClaimSetMemberPermissionsRequest request)
        {
            conn.InternalCallReducer(new Reducer.ClaimSetMemberPermissions(request));
        }
