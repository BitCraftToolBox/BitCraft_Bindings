...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportWallDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.WallDesc> records);
        public event ImportWallDescHandler? OnImportWallDesc;

        public void ImportWallDesc(System.Collections.Generic.List<BitCraftRegion.Types.WallDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportWallDesc(records));
        }
