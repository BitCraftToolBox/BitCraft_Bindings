...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageLootRarityDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.LootRarityDesc> records);
        public event StageLootRarityDescHandler? OnStageLootRarityDesc;

        public void StageLootRarityDesc(System.Collections.Generic.List<BitCraftGlobal.Types.LootRarityDesc> records)
        {
