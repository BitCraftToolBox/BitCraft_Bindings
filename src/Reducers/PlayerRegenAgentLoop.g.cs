...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void PlayerRegenAgentLoopHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerRegenLoopTimer timer);
        public event PlayerRegenAgentLoopHandler? OnPlayerRegenAgentLoop;

        public void PlayerRegenAgentLoop(BitCraftRegion.Types.PlayerRegenLoopTimer timer)
        {
            conn.InternalCallReducer(new Reducer.PlayerRegenAgentLoop(timer));
        }
