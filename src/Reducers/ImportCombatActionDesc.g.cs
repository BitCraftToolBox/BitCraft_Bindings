...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportCombatActionDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.CombatActionDesc> records);
        public event ImportCombatActionDescHandler? OnImportCombatActionDesc;

        public void ImportCombatActionDesc(System.Collections.Generic.List<BitCraftGlobal.Types.CombatActionDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportCombatActionDesc(records));
        }
