...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void GenerateWorldHandler(ReducerEventContext ctx, BitCraftRegion.Types.WorldGenWorldDefinition worldDefinition);
        public event GenerateWorldHandler? OnGenerateWorld;

        public void GenerateWorld(BitCraftRegion.Types.WorldGenWorldDefinition worldDefinition)
        {
            conn.InternalCallReducer(new Reducer.GenerateWorld(worldDefinition));
        }
