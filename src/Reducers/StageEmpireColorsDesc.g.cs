...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageEmpireColorsDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.EmpireColorDesc> records);
        public event StageEmpireColorsDescHandler? OnStageEmpireColorsDesc;

        public void StageEmpireColorsDesc(System.Collections.Generic.List<BitCraftGlobal.Types.EmpireColorDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageEmpireColorsDesc(records));
        }
