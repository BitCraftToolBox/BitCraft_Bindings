...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageDeployableDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.DeployableDesc> records);
        public event StageDeployableDescHandler? OnStageDeployableDesc;

        public void StageDeployableDesc(System.Collections.Generic.List<BitCraftGlobal.Types.DeployableDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageDeployableDesc(records));
        }
