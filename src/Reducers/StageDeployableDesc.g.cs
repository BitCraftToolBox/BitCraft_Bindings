...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void StageDeployableDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.DeployableDesc> records);
        public event StageDeployableDescHandler? OnStageDeployableDesc;

        public void StageDeployableDesc(System.Collections.Generic.List<BitCraftRegion.Types.DeployableDesc> records)
        {
