...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageCombatActionDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.CombatActionDesc> records);
        public event StageCombatActionDescHandler? OnStageCombatActionDesc;

        public void StageCombatActionDesc(System.Collections.Generic.List<BitCraftGlobal.Types.CombatActionDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageCombatActionDesc(records));
        }
