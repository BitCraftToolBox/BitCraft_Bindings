...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ClaimSetPurchaseSupplyThresholdHandler(ReducerEventContext ctx, BitCraftRegion.Types.ClaimSetPurchaseSupplyThresholdRequest request);
        public event ClaimSetPurchaseSupplyThresholdHandler? OnClaimSetPurchaseSupplyThreshold;

        public void ClaimSetPurchaseSupplyThreshold(BitCraftRegion.Types.ClaimSetPurchaseSupplyThresholdRequest request)
        {
            conn.InternalCallReducer(new Reducer.ClaimSetPurchaseSupplyThreshold(request));
        }
