...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ClaimTakeOwnershipHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerClaimTakeOwnershipRequest request);
        public event ClaimTakeOwnershipHandler? OnClaimTakeOwnership;

        public void ClaimTakeOwnership(BitCraftRegion.Types.PlayerClaimTakeOwnershipRequest request)
        {
            conn.InternalCallReducer(new Reducer.ClaimTakeOwnership(request));
        }
