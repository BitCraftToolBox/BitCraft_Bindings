...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportLocationStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.LocationState> records);
        public event ImportLocationStateHandler? OnImportLocationState;

        public void ImportLocationState(System.Collections.Generic.List<BitCraftRegion.Types.LocationState> records)
        {
