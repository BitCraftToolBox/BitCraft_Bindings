...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportLocationStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.LocationState> records);
        public event ImportLocationStateHandler? OnImportLocationState;

        public void ImportLocationState(System.Collections.Generic.List<BitCraftGlobal.Types.LocationState> records)
        {
            conn.InternalCallReducer(new Reducer.ImportLocationState(records));
        }
