...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportTargetStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.TargetState> records);
        public event ImportTargetStateHandler? OnImportTargetState;

        public void ImportTargetState(System.Collections.Generic.List<BitCraftRegion.Types.TargetState> records)
        {
