...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportTargetStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.TargetState> records);
        public event ImportTargetStateHandler? OnImportTargetState;

        public void ImportTargetState(System.Collections.Generic.List<BitCraftGlobal.Types.TargetState> records)
        {
            conn.InternalCallReducer(new Reducer.ImportTargetState(records));
        }
