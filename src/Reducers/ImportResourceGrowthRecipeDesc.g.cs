...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportResourceGrowthRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.ResourceGrowthRecipeDesc> records);
        public event ImportResourceGrowthRecipeDescHandler? OnImportResourceGrowthRecipeDesc;

        public void ImportResourceGrowthRecipeDesc(System.Collections.Generic.List<BitCraftGlobal.Types.ResourceGrowthRecipeDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportResourceGrowthRecipeDesc(records));
        }
