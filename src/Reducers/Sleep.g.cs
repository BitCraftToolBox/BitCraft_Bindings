...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void SleepHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerSleepRequest request);
        public event SleepHandler? OnSleep;

        public void Sleep(BitCraftRegion.Types.PlayerSleepRequest request)
        {
            conn.InternalCallReducer(new Reducer.Sleep(request));
        }
