...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportElevatorDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.ElevatorDesc> records);
        public event ImportElevatorDescHandler? OnImportElevatorDesc;

        public void ImportElevatorDesc(System.Collections.Generic.List<BitCraftRegion.Types.ElevatorDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportElevatorDesc(records));
        }
