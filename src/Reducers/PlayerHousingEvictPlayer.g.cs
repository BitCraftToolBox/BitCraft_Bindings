...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void PlayerHousingEvictPlayerHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerHousingEvictPlayerRequest request);
        public event PlayerHousingEvictPlayerHandler? OnPlayerHousingEvictPlayer;

        public void PlayerHousingEvictPlayer(BitCraftRegion.Types.PlayerHousingEvictPlayerRequest request)
        {
            conn.InternalCallReducer(new Reducer.PlayerHousingEvictPlayer(request));
        }
