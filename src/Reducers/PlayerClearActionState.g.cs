...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void PlayerClearActionStateHandler(ReducerEventContext ctx, ulong actorId, BitCraftRegion.Types.PlayerActionType currentAction, BitCraftRegion.Types.PlayerActionLayer layer, BitCraftRegion.Types.PlayerActionResult lastActionResult);
        public event PlayerClearActionStateHandler? OnPlayerClearActionState;

        public void PlayerClearActionState(ulong actorId, BitCraftRegion.Types.PlayerActionType currentAction, BitCraftRegion.Types.PlayerActionLayer layer, BitCraftRegion.Types.PlayerActionResult lastActionResult)
        {
            conn.InternalCallReducer(new Reducer.PlayerClearActionState(actorId, currentAction, layer, lastActionResult));
        }
