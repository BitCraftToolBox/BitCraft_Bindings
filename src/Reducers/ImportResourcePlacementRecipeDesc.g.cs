...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportResourcePlacementRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.ResourcePlacementRecipeDesc> records);
        public event ImportResourcePlacementRecipeDescHandler? OnImportResourcePlacementRecipeDesc;

        public void ImportResourcePlacementRecipeDesc(System.Collections.Generic.List<BitCraftRegion.Types.ResourcePlacementRecipeDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportResourcePlacementRecipeDesc(records));
        }
