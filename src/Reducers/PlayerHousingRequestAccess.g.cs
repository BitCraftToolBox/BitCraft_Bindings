...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void PlayerHousingRequestAccessHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerHousingRequestAccessRequest request);
        public event PlayerHousingRequestAccessHandler? OnPlayerHousingRequestAccess;

        public void PlayerHousingRequestAccess(BitCraftRegion.Types.PlayerHousingRequestAccessRequest request)
        {
            conn.InternalCallReducer(new Reducer.PlayerHousingRequestAccess(request));
        }
