...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void EmpireAddSiegeSuppliesHandler(ReducerEventContext ctx, BitCraftRegion.Types.EmpireAddSiegeSuppliesRequest request);
        public event EmpireAddSiegeSuppliesHandler? OnEmpireAddSiegeSupplies;

        public void EmpireAddSiegeSupplies(BitCraftRegion.Types.EmpireAddSiegeSuppliesRequest request)
        {
            conn.InternalCallReducer(new Reducer.EmpireAddSiegeSupplies(request));
        }
