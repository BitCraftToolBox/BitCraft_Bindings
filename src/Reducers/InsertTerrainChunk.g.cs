...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void InsertTerrainChunkHandler(ReducerEventContext ctx, BitCraftRegion.Types.TerrainChunkState terrainChunk, System.Collections.Generic.List<BitCraftRegion.Types.WorldGenGeneratedBuilding> buildings, System.Collections.Generic.List<BitCraftRegion.Types.WorldGenGeneratedResourceDeposit> resources);
        public event InsertTerrainChunkHandler? OnInsertTerrainChunk;

        public void InsertTerrainChunk(BitCraftRegion.Types.TerrainChunkState terrainChunk, System.Collections.Generic.List<BitCraftRegion.Types.WorldGenGeneratedBuilding> buildings, System.Collections.Generic.List<BitCraftRegion.Types.WorldGenGeneratedResourceDeposit> resources)
        {
            conn.InternalCallReducer(new Reducer.InsertTerrainChunk(terrainChunk, buildings, resources));
        }
