...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageContributionLootDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.ContributionLootDesc> records);
        public event StageContributionLootDescHandler? OnStageContributionLootDesc;

        public void StageContributionLootDesc(System.Collections.Generic.List<BitCraftGlobal.Types.ContributionLootDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageContributionLootDesc(records));
        }
