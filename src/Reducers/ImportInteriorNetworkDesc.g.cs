...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportInteriorNetworkDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.InteriorNetworkDesc> records);
        public event ImportInteriorNetworkDescHandler? OnImportInteriorNetworkDesc;

        public void ImportInteriorNetworkDesc(System.Collections.Generic.List<BitCraftGlobal.Types.InteriorNetworkDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportInteriorNetworkDesc(records));
        }
