...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportBuffTypeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.BuffTypeDesc> records);
        public event ImportBuffTypeDescHandler? OnImportBuffTypeDesc;

        public void ImportBuffTypeDesc(System.Collections.Generic.List<BitCraftRegion.Types.BuffTypeDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportBuffTypeDesc(records));
        }
