...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportConstructionRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.ConstructionRecipeDesc> records);
        public event ImportConstructionRecipeDescHandler? OnImportConstructionRecipeDesc;

        public void ImportConstructionRecipeDesc(System.Collections.Generic.List<BitCraftGlobal.Types.ConstructionRecipeDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportConstructionRecipeDesc(records));
        }
