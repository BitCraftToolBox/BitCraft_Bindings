...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageTerraformRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.TerraformRecipeDesc> records);
        public event StageTerraformRecipeDescHandler? OnStageTerraformRecipeDesc;

        public void StageTerraformRecipeDesc(System.Collections.Generic.List<BitCraftGlobal.Types.TerraformRecipeDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageTerraformRecipeDesc(records));
        }
