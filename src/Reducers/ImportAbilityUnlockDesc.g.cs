...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportAbilityUnlockDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.AbilityUnlockDesc> records);
        public event ImportAbilityUnlockDescHandler? OnImportAbilityUnlockDesc;

        public void ImportAbilityUnlockDesc(System.Collections.Generic.List<BitCraftRegion.Types.AbilityUnlockDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportAbilityUnlockDesc(records));
        }
