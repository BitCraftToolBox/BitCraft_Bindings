...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportResourceStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.ResourceState> records);
        public event ImportResourceStateHandler? OnImportResourceState;

        public void ImportResourceState(System.Collections.Generic.List<BitCraftGlobal.Types.ResourceState> records)
        {
            conn.InternalCallReducer(new Reducer.ImportResourceState(records));
        }
