...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportResourceStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.ResourceState> records);
        public event ImportResourceStateHandler? OnImportResourceState;

        public void ImportResourceState(System.Collections.Generic.List<BitCraftRegion.Types.ResourceState> records)
        {
