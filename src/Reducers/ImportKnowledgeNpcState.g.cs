...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportKnowledgeNpcStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.KnowledgeNpcState> records);
        public event ImportKnowledgeNpcStateHandler? OnImportKnowledgeNpcState;

        public void ImportKnowledgeNpcState(System.Collections.Generic.List<BitCraftGlobal.Types.KnowledgeNpcState> records)
        {
            conn.InternalCallReducer(new Reducer.ImportKnowledgeNpcState(records));
        }
