...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportKnowledgeNpcStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.KnowledgeNpcState> records);
        public event ImportKnowledgeNpcStateHandler? OnImportKnowledgeNpcState;

        public void ImportKnowledgeNpcState(System.Collections.Generic.List<BitCraftRegion.Types.KnowledgeNpcState> records)
        {
