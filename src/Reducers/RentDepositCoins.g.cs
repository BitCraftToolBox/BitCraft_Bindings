...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void RentDepositCoinsHandler(ReducerEventContext ctx, BitCraftRegion.Types.RentDepositCoinsRequest request);
        public event RentDepositCoinsHandler? OnRentDepositCoins;

        public void RentDepositCoins(BitCraftRegion.Types.RentDepositCoinsRequest request)
        {
            conn.InternalCallReducer(new Reducer.RentDepositCoins(request));
        }
