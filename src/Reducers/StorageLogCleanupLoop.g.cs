...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void StorageLogCleanupLoopHandler(ReducerEventContext ctx, BitCraftRegion.Types.StorageLogCleanupLoopTimer timer);
        public event StorageLogCleanupLoopHandler? OnStorageLogCleanupLoop;

        public void StorageLogCleanupLoop(BitCraftRegion.Types.StorageLogCleanupLoopTimer timer)
        {
            conn.InternalCallReducer(new Reducer.StorageLogCleanupLoop(timer));
        }
