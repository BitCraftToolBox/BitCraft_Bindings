...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportEnemyScalingDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.EnemyScalingDesc> records);
        public event ImportEnemyScalingDescHandler? OnImportEnemyScalingDesc;

        public void ImportEnemyScalingDesc(System.Collections.Generic.List<BitCraftRegion.Types.EnemyScalingDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportEnemyScalingDesc(records));
        }
