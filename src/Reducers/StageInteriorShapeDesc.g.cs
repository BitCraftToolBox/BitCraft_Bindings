...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void StageInteriorShapeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.InteriorShapeDesc> records);
        public event StageInteriorShapeDescHandler? OnStageInteriorShapeDesc;

        public void StageInteriorShapeDesc(System.Collections.Generic.List<BitCraftRegion.Types.InteriorShapeDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageInteriorShapeDesc(records));
        }
