...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void ImportPremiumServiceDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.PremiumServiceDesc> records);
        public event ImportPremiumServiceDescHandler? OnImportPremiumServiceDesc;

        public void ImportPremiumServiceDesc(System.Collections.Generic.List<BitCraftGlobal.Types.PremiumServiceDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportPremiumServiceDesc(records));
        }
