...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void CrumbTailCleanupAgentLoopHandler(ReducerEventContext ctx, BitCraftRegion.Types.CrumbTrailCleanupTimer timer);
        public event CrumbTailCleanupAgentLoopHandler? OnCrumbTailCleanupAgentLoop;

        public void CrumbTailCleanupAgentLoop(BitCraftRegion.Types.CrumbTrailCleanupTimer timer)
        {
            conn.InternalCallReducer(new Reducer.CrumbTailCleanupAgentLoop(timer));
        }
