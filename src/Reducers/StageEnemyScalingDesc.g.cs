...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageEnemyScalingDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.EnemyScalingDesc> records);
        public event StageEnemyScalingDescHandler? OnStageEnemyScalingDesc;

        public void StageEnemyScalingDesc(System.Collections.Generic.List<BitCraftGlobal.Types.EnemyScalingDesc> records)
        {
