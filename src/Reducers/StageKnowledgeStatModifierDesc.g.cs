...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageKnowledgeStatModifierDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.KnowledgeStatModifierDesc> records);
        public event StageKnowledgeStatModifierDescHandler? OnStageKnowledgeStatModifierDesc;

        public void StageKnowledgeStatModifierDesc(System.Collections.Generic.List<BitCraftGlobal.Types.KnowledgeStatModifierDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageKnowledgeStatModifierDesc(records));
        }
