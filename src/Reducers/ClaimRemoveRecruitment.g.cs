...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ClaimRemoveRecruitmentHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerClaimRemoveRecruitmentRequest request);
        public event ClaimRemoveRecruitmentHandler? OnClaimRemoveRecruitment;

        public void ClaimRemoveRecruitment(BitCraftRegion.Types.PlayerClaimRemoveRecruitmentRequest request)
        {
            conn.InternalCallReducer(new Reducer.ClaimRemoveRecruitment(request));
        }
