...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void ImportBuildingPortalDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.BuildingPortalDesc> records);
        public event ImportBuildingPortalDescHandler? OnImportBuildingPortalDesc;

        public void ImportBuildingPortalDesc(System.Collections.Generic.List<BitCraftRegion.Types.BuildingPortalDesc> records)
        {
            conn.InternalCallReducer(new Reducer.ImportBuildingPortalDesc(records));
        }
