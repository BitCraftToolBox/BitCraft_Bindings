...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void StageClaimTechDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftRegion.Types.ClaimTechDesc> records);
        public event StageClaimTechDescHandler? OnStageClaimTechDesc;

        public void StageClaimTechDesc(System.Collections.Generic.List<BitCraftRegion.Types.ClaimTechDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageClaimTechDesc(records));
        }
