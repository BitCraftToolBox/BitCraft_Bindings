...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void AttackImpactMigratedHandler(ReducerEventContext ctx, BitCraftRegion.Types.AttackImpactTimerMigrated timer);
        public event AttackImpactMigratedHandler? OnAttackImpactMigrated;

        public void AttackImpactMigrated(BitCraftRegion.Types.AttackImpactTimerMigrated timer)
        {
            conn.InternalCallReducer(new Reducer.AttackImpactMigrated(timer));
        }
