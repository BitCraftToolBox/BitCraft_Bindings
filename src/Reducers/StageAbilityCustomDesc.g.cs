...
namespace BitCraftGlobal.Types
{
    ...
    {
        public delegate void StageAbilityCustomDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraftGlobal.Types.AbilityCustomDesc> records);
        public event StageAbilityCustomDescHandler? OnStageAbilityCustomDesc;

        public void StageAbilityCustomDesc(System.Collections.Generic.List<BitCraftGlobal.Types.AbilityCustomDesc> records)
        {
            conn.InternalCallReducer(new Reducer.StageAbilityCustomDesc(records));
        }
