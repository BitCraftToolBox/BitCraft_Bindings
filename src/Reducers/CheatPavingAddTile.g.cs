...
namespace BitCraftRegion.Types
{
    ...
    {
        public delegate void CheatPavingAddTileHandler(ReducerEventContext ctx, BitCraftRegion.Types.PlayerPavingPlaceTileRequest request);
        public event CheatPavingAddTileHandler? OnCheatPavingAddTile;

        public void CheatPavingAddTile(BitCraftRegion.Types.PlayerPavingPlaceTileRequest request)
        {
            conn.InternalCallReducer(new Reducer.CheatPavingAddTile(request));
        }
